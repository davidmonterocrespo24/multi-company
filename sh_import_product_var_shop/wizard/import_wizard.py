...
class ImportProductVarWizard(models.TransientModel):
    _name = "import.product.var.shop.wizard"
    ...
    def read_xls_book(self):
        ...
        # emulate Sheet.get_rows for pre-0.10.4
        values_sheet = []
        for rowx, row in enumerate(map(sheet.row, range(sheet.nrows)), 1):
            ...
            for colx, cell in enumerate(row, 1):
                if cell.ctype is xlrd.XL_CELL_NUMBER:
                    ...
                    # emulate xldate_as_datetime for pre-0.10.3
